...
After updating the entity framework project `GreenOnion.Entities` with your 
...
in the `GreenOnion.DB` project.  Additional SQL objects may be defined in the 
`GreenOnion.DB` as required.  This project generates a dacpac for use with 
